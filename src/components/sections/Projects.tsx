...
export default function Projects() {
  ...
  return (
    <section id="projects" className="w-full py-24 bg-(--bg-alt)/80">
          ...
          >
            {filtered.map((project, i) => (
              <motion.div
                ...
                className="hover-lift group relative flex flex-col rounded-2xl border border-(--border) hover:border-(--cyan)/40 transition-all duration-300 overflow-hidden bg-(--card)"
              >
                {/* Browser Chrome */}
