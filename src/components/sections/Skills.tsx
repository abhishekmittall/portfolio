      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              "CodePush (OTA)", "CleverTap", "AppsFlyer", "Stripe",
              "Push Notifications", "In-App Purchases", "Android Studio",
              "Xcode", "Flipper", "Postman", "Sentry", "Bitbucket",
              "Jira", "Figma", "pgAdmin", "SCSS", "Bootstrap", "RxJS"
            ].map((tech) => (
              <span
                key={tech}
