...
export default function About() {
  return (
    <section id="about" className="w-full py-24 bg-(--bg-alt)/80">
          ...
          >
            {traits.map((trait, i) => (
              <motion.div
                ...
                className="hover-lift group relative bg-(--card) border border-(--border) rounded-2xl p-6 hover:border-(--cyan)/40 transition-all duration-300 overflow-hidden"
              >
                {/* Corner accent */}
                <div
